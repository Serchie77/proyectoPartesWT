...
$actualizarRegistro = $conexionbd->prepare("UPDATE partes 
    SET fechaInicio = :fechaInicio, fechaFin = :fechaFin, totalHorasNormales = :totalHorasNormales, totalHorasExtras = :totalHorasExtras, horasViaje = :horasViaje,
    comentarios = :comentarios, idUsuario = :idUsuario, idProyecto = :idProyecto, 
