    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h1 class="modal-title fs-5 text-white" id="editarParteModalLabel">
                    <i class="fa-solid fa-file-pen"></i> Editar Partes
                </h1>
                ...
                <form action="/proyectoWT/models/partes/actualizarParte.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="totalHorasNormales" class="form-label">Horas:</label>
                            <input type="number" step="0.01" name="totalHorasNormales" id="totalHorasNormales" class="form-control form-control-sm">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="totalHorasExtras" class="form-label">Horas Extras:</label>
                            <input type="number" step="0.01" name="totalHorasExtras" id="totalHorasExtras" class="form-control form-control-sm">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="horasViaje" class="form-label">Horas Viaje:</label>
                            <input type="number" step="0.01" name="horasViaje" id="horasViaje" class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="mb-3">
